...
public class Kamaz extends Masin {
    ...
    public Kamaz(Long id, String masinAdi, String reng, double qiymet, int masinTekerSayi, String firmaAdi, String model, double yolNeqliyyatCezasiMeblegi) {
        setId(id);
    ...
    public void yolNeqliyyatCezaOde(double cezaMebleg) {
        ...
        System.out.println(getMasinAdi() + " bu tipli masinin yol neqliyyat " +
                "cezasi umumu meblegi : " + getYolNeqliyyatCezasiMeblegi());
    }
