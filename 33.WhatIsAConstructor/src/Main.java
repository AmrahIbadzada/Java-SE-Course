...
public class Main {
    public static void main(String[] args) {
        ...
        * super – valideyn (üst) sinifə istinad edir.
        * super() – valideyn sinifin constructor metodunu çağırmaq üçün istifadə olunur.
        ...
        Override — alt sinifdə valideyn sinifin metodunu eyni imza ilə təkrar yazmaqdır. Bu, alt sinifin öz versiyasını təqdim etməsinə imkan verir.
